...
### №1 Типы кабелей: Ethernet чаще всего использует витую пару (UTP/STP), реже — оптоволокно. Коаксиальный кабель (10Base-5, 10Base-2) сегодня практически не встречается. 
UTP (Unshielded Twisted Pair): Это неэкранированная витая пара.
Плюсы: Дешевизна, гибкость, простота монтажа, стандартность разъемов (RJ-45).   
Минусы: Чувствительность к электромагнитным помехам и ограничение по длине сегмента (обычно до 100 метров).
###
